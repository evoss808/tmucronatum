...
One of the most impressive is the <span eid="Q252182"> Arbol del Tule </span>, located on the church grounds in Santa Maria del Tule in Oaxaca. With a circumference of 42 m, it is considered to have the largest tree circumference in the world.[^ref11] DNA has proven it is a single tree with many large buttresses. Age estimates range from 1,200-1600 years old, with one local Zapotec legend claiming the tree was planted 1400 years ago by Pechocha, priest of Ehecatl, the Aztec god of wind. Visitors nicknamed Arbol del Tule the "Tree of Life" because of the animals supposedly visible in its gnarled trunk.
